...
var statuses = [`sAKU#2915`];
var timers = 50000;
const owners = [`999643171724214272`,``,``];//اي دي الاونرات

client.on("ready", () => {
  console.log(`Logged in as ${client.user.tag}`);
 client.user.setActivity(`sAKU#2915`, { type: 'WATCHING' })  
...
client.on("message", message => {
  if (message.content.toLowerCase().startsWith(prefix + "help".toLowerCase())) {
    ...
    let help = new Discord.MessageEmbed()
      ...
      .setFooter(`Developed by Givara `, client.user.displayAvatarURL())
